...
const { Admin, Catalog, Category, Product, PreviewProduct } = require('./resourceOptions');
...
const options = {
  locale: {
    ...
    translations: {
      ...
      labels: {
        ...
        Category: "Категории",
        Product: "Товары",
        PreviewProduct: "Изображение на главной странице"
      },
      buttons: {
        filter: "Фильтр",
        save: "Сохранить",
  ...
  resources: [Admin, Catalog, Category, Product, PreviewProduct],
  branding: {
